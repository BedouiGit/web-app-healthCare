...
<html lang="en">
  <head>
    ...
    <!-- End Layout styles -->
    <link rel="shortcut icon" href="assets/images/hh.png" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block">Help : +000 2992 709</li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle" src="assets/images/faces/khalilpdp.jpg" alt="Profile image"> </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="assets/images/faces/khalilpdp.jpg" alt="Profile image">
                  <p class="mb-1 mt-3 font-weight-semibold">Khalil Bedoui</p>
                  <p class="font-weight-light text-muted mb-0">bedoui.khalil2002@gmail.com</p>
                </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="profile-image">
                  <img class="img-xs rounded-circle" src="assets/images/faces/khalilpdp.jpg" alt="profile image">
                  <div class="dot-indicator bg-success"></div>
                </div>
                <div class="text-wrapper">
                  <p class="profile-name">Khalil Bedoui</p>
                  <p class="designation">Gestion Fitness</p>
                </div>
              </a>
            </li>
            ...
            <form action="" method="POST">
                <table border="3" align="center">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="nomEx" id="nomEx" minlenght="3" maxlength="50"></td>
                    </tr>
                    <tr>
                        <td>
...
const objectifInput = document.getElementById('nomEx');
        ...
        <!--<div class="main-panel"> 
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © HealthifyMe.com 2020</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="https://www.bootstrapdash.com/bootstrap-admin-template/" target="_blank"> admin templates</a> from HealthifyMe.com</span>
            </div>
          </footer>-->
          <!-- partial -->
        </div>
